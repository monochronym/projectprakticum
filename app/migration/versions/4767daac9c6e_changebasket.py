...
Revision ID: 4767daac9c6e
Revises: 
Create Date: 2025-06-07 23:48:15.648262
...
def upgrade() -> None:
    ...
    sa.Column('imageType', sa.String(), nullable=False),
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('goodId', sa.Uuid(), nullable=False),
